...
<div class="row mt-3">
    <div class="col-md-4 offset-4">
        <div class="row mt-3">
            <i class="fa-solid fa-plate-wheat"><h1># Clientes</h1></i>
        </div>
        <br>
    </br>
...
<div class="table-responsive">
    <table class="table table-bordered table-hover">
        <thead><tr><th>Id</th><th>Nombre</th><th>Apellidos</th><th>Edad</th><th>Correo</th><th>Editar</th><th>Eliminar</th></tr></thead>
        ...
        <tr>
            ...
            <td>{{$row->correo}}</td>
            <td>
                <a href="{{ url('clientes',[$row]) }}" class="btn btn-dark"><i class="fa-solid fa-edit"></i> </a>
            </td>

            <td>
                <form method="POST" action="{{ url('clientes',[$row]) }}">
                    @method("delete")
                    @csrf
