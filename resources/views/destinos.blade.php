...
<div class="row mt-3">
    <div class="col-md-4 offset-4">
        <div class="row mt-3">
            <i class="fa-solid fa-plate-wheat"><h1># Destinos</h1></i>
        </div>
        <br>
    </br>
<div class="d-grid mx-auto">
    <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modalartes">
        <i class="fa-solid fa-circle-plus"> </i> Añadir Destinos
    </button>
    <br>
</br>
...
<div class="table-responsive">
    <table class="table table-bordered table-hover">
        <thead><tr><th>Id</th><th>Nombre</th><th>Vista</th><th>Id municipio</th><th>Direccion</th><th>Codigo postal</th><th>Editar</th><th>Eliminar</th></tr></thead>
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('destinos',[$row]) }}" class="btn btn-dark"><i class="fa-solid fa-edit"></i> </a>
            </td>

            <td>
                <form method="POST" action="{{ url('destinos',[$row]) }}">
                    @method("delete")
                    @csrf
