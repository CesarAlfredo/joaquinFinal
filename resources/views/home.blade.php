...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="button-container">
    ...
    <a href="/municipios"><button class="button">MUNICIPIOS</button></a>
    <a href="/ingredientes"><button class="button">BOLETOS</button></a>
    <a href="/destinos"><button class="button">DESTINOS</button></a>
  </div>

  <div class="container mx-auto flex" id="content">
  ...
  <video autoplay muted loop id="destinos">
    <source src="/img/vp.mp4" type="video/mp4">
